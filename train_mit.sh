...
# 1. 修改日志输出路径
#SBATCH --output=logs/mit/train/%j.out
#SBATCH --error=logs/mit/train/%j.err
...
echo ">>> Start Fast Testing OV-CZSL (CLIP+FT+NEL) | Dataset: MIT-States | Config: ${CONFIG} | GPUs: ${N_GPU} <<<"
